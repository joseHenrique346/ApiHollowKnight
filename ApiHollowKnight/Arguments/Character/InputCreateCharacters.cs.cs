...
namespace ApiHollowKnight.Arguments.Character
{
    ...
    public class InputCreatedCharacters(string name, string description, string gender, int typeId, int speciesId, int placesId, decimal health, string color, string imageUrl)
    {
